...
from .label_center_img import CenterImg, signal_shape_type, signal_set_shape_list_selected, \
    signal_del_shape, signal_draw_selected_shape, signal_draw_shape_done, signal_one_collection_done, \
    BaseImgFrame, signal_move2new_folder, signal_shape_info_update, CenterImgView
...
__all__ = ['CenterImg', 'ClassStatWidget', 'SelectItem', 'ProgressWindow', 'BaseButtonGroup',
           'WaitingLabel', 'CustomMessageBox', 'signal_shape_type', 'BaseSelectList', 'PushButtonWaiting',
           'signal_set_shape_list_selected', 'signal_del_shape', 'signal_draw_selected_shape',
           'signal_draw_shape_done', 'signal_one_collection_done', 'BaseImgFrame', 'signal_move2new_folder',
           'signal_shape_info_update', 'signal_show_plain_img', 'signal_show_label_img', 'signal_button_selected_done',
