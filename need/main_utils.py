...
def connect_all_other_signals(main_window):
    main_window.main_ui.checkBox_hide_cross.clicked.connect(main_window.set_hide_cross)
    main_window.main_ui.checkBox_one_label.pressed.connect(main_window.raise_label_mode_conflict)
    main_window.main_ui.checkBox_one_label.toggled.connect(main_window.set_one_file_label)
    ...
    main_window.main_ui.shape_list.itemSelectionChanged.connect(main_window.set_info_widget_selected)

    main_window.main_ui.pushButton_35.clicked.connect(main_window.undo_painting)
    main_window.main_ui.pushButton_36.clicked.connect(main_window.save_ann_img)
    main_window.main_ui.pushButton_40.clicked.connect(main_window.clear_painted_img)
    main_window.main_ui.pushButton_50.clicked.connect(main_window.set_m_cls_default_c)
    ...
    main_window.main_ui.pushButton_auto_infer.clicked.connect(main_window.auto_inference)
    main_window.main_ui.pushButton_bg.pressed.connect(main_window.set_semantic_bg_when_press)
    main_window.main_ui.pushButton_build_task.pressed.connect(main_window.show_task_window)
    main_window.main_ui.pushButton_check_label.clicked.connect(main_window.check_dataset)
    main_window.main_ui.pushButton_class_list.clicked.connect(main_window.fold_list)
    main_window.main_ui.pushButton_cls_back.clicked.connect(main_window.cls_back)
    main_window.main_ui.pushButton_cross_color.clicked.connect(main_window.change_cross_color)
    main_window.main_ui.pushButton_delay.clicked.connect(main_window.set_scan_delay)
    main_window.main_ui.pushButton_delete.clicked.connect(lambda: main_window.del_img(None))
    main_window.main_ui.pushButton_font_color.clicked.connect(main_window.change_font_color)
    main_window.main_ui.pushButton_generate_train.clicked.connect(main_window.generate_train)
    main_window.main_ui.pushButton_goto_train.clicked.connect(lambda: main_window.add_to_train_val(dst_part='train'))
    main_window.main_ui.pushButton_goto_val.clicked.connect(lambda: main_window.add_to_train_val(dst_part='val'))
    main_window.main_ui.pushButton_jump.clicked.connect(main_window.img_jump)
    ...
    main_window.main_ui.pushButton_update_png.clicked.connect(main_window.update_sem_pngs)

    main_window.main_ui.radioButton_read.toggled.connect(main_window.set_read_mode)

    main_window.main_ui.spinBox.valueChanged.connect(main_window.change_pen_size)
    main_window.main_ui.spinBox_5.valueChanged.connect(main_window.change_font_size)
    main_window.main_ui.spinBox_6.valueChanged.connect(main_window.change_pen_size)

    main_window.main_ui.tabWidget.currentChanged.connect(main_window.set_work_mode)

    main_window.main_ui.toolBox.currentChanged.connect(main_window.set_tool_mode)
    ...
    signal_auto_infer_done.signal.connect(main_window.auto_inference_done)
    signal_ai_progress_value.signal.connect(main_window.update_progress_value)
    signal_ai_progress_text.signal.connect(main_window.update_progress_text)
    signal_usp_progress_value.signal.connect(main_window.update_progress_value)
    signal_usp_progress_text.signal.connect(main_window.update_progress_text)
...
def init_menu(main_window):
    ...
    main_window.main_ui.groupBox_1.customContextMenuRequested.connect(
        lambda: main_window.show_menu(main_window.menu_task))
    main_window.main_ui.groupBox_2.customContextMenuRequested.connect(
        lambda: main_window.show_menu(main_window.menu_task))
    ...
    main_window.main_ui.groupBox_img_edit.customContextMenuRequested.connect(
    ...
    main_window.main_ui.class_list.customContextMenuRequested.connect(
    ...
    main_window.main_ui.shape_list.customContextMenuRequested.connect(
    ...
    main_window.main_ui.listWidget_sem.customContextMenuRequested.connect(
        lambda: main_window.show_menu(main_window.menu_set_shape_info))
    main_window.main_ui.listWidget_ins.customContextMenuRequested.connect(
        lambda: main_window.show_menu(main_window.menu_set_shape_info))

    main_window.main_ui.action_cn.triggered.connect(lambda: main_window.set_language('CN'))
    main_window.main_ui.action_en.triggered.connect(lambda: main_window.set_language('EN'))
    main_window.main_ui.action_about.triggered.connect(main_window.about_hhl)
